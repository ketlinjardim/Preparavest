      ...
      <View style={estilo.contentContainer}>
        ...
        <View style={estilo.section}>
          ...
          <View style={estilo.sectionContent}>
            ...
            <Pressable
              onPress={() => Linking.openURLURL('https://www.gov.br/inep/pt-br/areas-de-atuacao/avaliacao-e-exames-educacionais/enem', 'Vestibular')}>
        ...
        <View style={estilo.section}>
          ...
          <View style={estilo.sectionContent}>
            ...
            <Pressable
              onPress={() => Linking.openURL('https://www.fuvest.br/', 'Vestibular')}>
        ...
        <View style={estilo.section}>
          ...
          <View style={estilo.sectionContent}>
            ...
            <Pressable
              onPress={() => Linking.openURL('https://www.comvest.unicamp.br/', 'Vestibular')}>
        ...
        <View style={estilo.section}>
          ...
          <View style={estilo.sectionContent}>
            ...
            <Pressable
              onPress={() => Linking.openURL('https://www.vunesp.com.br/', 'Vestibular')}>
